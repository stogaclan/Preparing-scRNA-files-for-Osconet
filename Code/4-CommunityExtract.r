...
alpha=0.2
experiment="her4_les" # Change this to your datset name/experiment name/subpopulation name
cases=c('D0','D1','D2','D3', 'D5', 'D6','D7', 'D8','D9') #Change this to reflect the number of 'D' clusters you have in Input Directory

outdir='C:/Users/SotoLabPC/Desktop/Osconet_stefano/larval_test/Results'
plotroot='C:/Users/SotoLabPC/Desktop/Osconet_stefano/larval_test/Plots/Community'

if(!dir.exists('C:/Users/SotoLabPC/Desktop/Osconet_stefano/larval_test/Plots')) {
  dir.create('C:/Users/SotoLabPC/Desktop/Osconet_stefano/larval_test/Plots')}
...
for(case in cases){
	print(case)
  plotdir=file.path(plotroot,paste0('Cavone2021_',experiment,case))
  if(!dir.exists(plotdir)) {
    dir.create(plotdir)}
#datafile= file containing the preprocessed data, output of the filtering step, before oscoNet
datafile=paste0('C:/Users/SotoLabPC/Desktop/Osconet_stefano/larval_test/OsconetInput/filter',experiment,case,'_',alpha,'.csv')
#filename= graph (network) estimated by OscoNet -Only significant co-oscillators
filename=paste0('C:/Users/SotoLabPC/Desktop/Osconet_stefano/larval_test/OsconetOutput/filter',experiment,case,'_',alpha,'.out.csv')
#filepsi=Matrix of all the estimated psi for the genes in datafile. 
filepsi=paste0('C:/Users/SotoLabPC/Desktop/Osconet_stefano/larval_test/OsconetOutput/filter',experiment,case,'_',alpha,'.psi_ng.csv')
...
outfile=paste0(outdir,'/','Cavone2021_',experiment,case,'_',alpha,'Comm.csv')
...
write.csv(Report10,file=paste(outdir,'/Report_',experiment,case,'_',alpha,'.csv',sep=''))
